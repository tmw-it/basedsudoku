...
class SudokuBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final cellSize = (size - 32) / 9; // Account for padding (16px on each side)
        return SizedBox(
          width: size,
          height: size,
          child: Padding(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: value != 0
                            ...
                            children: [
                              Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    color: textColor,
                                    fontSize: cellSize * 0.6, // 60% of cell size
                        ...
                        : _buildNotes(context, notes, cellSize),
                  ),
                );
              },
            ),
  ...
  Widget _buildNotes(BuildContext context, Set<int> notes, double cellSize) {
